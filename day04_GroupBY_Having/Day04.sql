...
Select department,count(join_date)as joined_after_2020 from employees where join_date > '01-01-2020' Group By department 
...
Select department, count(*)as emp_count, max(salary) as highest_salary, min(salary) as lowest_salary, avg(salary) as average_salary from employees group by department order by emp_count DESC
